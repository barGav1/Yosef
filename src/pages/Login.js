    ...
    const loginUser = async (user) => {
        try {
            ...
            if (response.status === 200) {
                ...
                Cookies.set('user_id', response.data.user.id, { path: '/' });
                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" action="#" onSubmit={handleSubmit}>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-start">
                                        <div className="flex items-center h-5">
                                            <input id="remember" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800" onChange={handleRememberMe} checked={rememberMe}/>
                                        </div>
                                ...
                                <button type="submit" className="w-full px-4 py-2 rounded-md bg-blue-500 text-white font-bold hover:bg-blue-700">Sign In</button>
